...
def main():
    ...
    parser.add_argument('--img-path', default='/home/jovyan/kvasir_dataset/kvasir-dataset/polyps/interest1',
                        type=str, required=False,
                        help='Path to the input image or directory containing images.')
    parser.add_argument('--outdir', type=str, default='/home/jovyan/videos_renders/point_clouds/kvasir/interest1',
